...
class TransformerEncoderLayerWithStackedAdapter(nn.Module):
    def __init__(self,
                 feature_size,
...
class TransformerEncoderWithStackedAdapter(nn.Module):
    def __init__(self, feature_size, layer: TransformerEncoderLayerWithStackedAdapter, num_layers: int):
        super().__init__()
