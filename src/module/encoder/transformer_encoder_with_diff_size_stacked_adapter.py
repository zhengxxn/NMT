...
class TransformerEncoderLayerWithDiffSizeStackedAdapter(nn.Module):
    def __init__(self,
                 feature_size,
...
class TransformerEncoderWithDiffSizeStackedAdapter(nn.Module):
    def __init__(self,
                 feature_size,
                 layers: [TransformerEncoderLayerWithDiffSizeStackedAdapter],
                 num_layers: int):
        super().__init__()
