...
class TransformerEncoderLayerWithStackedMultiHeadAdapter(nn.Module):
    def __init__(self,
                 feature_size,
        ...
        # make adapter
        self.adapters = StackedMultiHeadAdapter(domain_adapter_dict=domain_adapter_dict,
...
class TransformerEncoderWithStackedMultiHeadAdapter(nn.Module):
    def __init__(self, feature_size, layer: TransformerEncoderLayerWithStackedMultiHeadAdapter, num_layers: int):
        super().__init__()
