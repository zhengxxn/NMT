...
class TransformerDecoderLayerWithDiffSizeStackedAdapter(nn.Module):
    ...
    def __init__(self,
                 ...
                 domain_adapter_dict,
                 dropout_rate):
        super(TransformerDecoderLayerWithDiffSizeStackedAdapter, self).__init__()
...
class TransformerDecoderWithDiffSizeStackedAdapter(nn.Module):
    ...
    def __init__(self,
        ...
        super(TransformerDecoderWithDiffSizeStackedAdapter, self).__init__()
