...
from module.adapter.stacked_multi_head_adapter import StackedMultiHeadAdapter
...
class TransformerDecoderLayerWithStackedMultiHeadAdapter(nn.Module):
    ...
    def __init__(self,
                 ...
                 domain_adapter_dict,
                 dropout_rate):
        super(TransformerDecoderLayerWithStackedMultiHeadAdapter, self).__init__()
        ...
        self.adapter = StackedMultiHeadAdapter(domain_adapter_dict, feature_size, dropout_rate)
...
class TransformerDecoderWithStackedMultiHeadAdapter(nn.Module):
    ...
    def __init__(self,
        ...
        super(TransformerDecoderWithStackedMultiHeadAdapter, self).__init__()
