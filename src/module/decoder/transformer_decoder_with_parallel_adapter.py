...
class TransformerDecoderLayerWithParallelAdapter(nn.Module):
    ...
    def __init__(self,
        ...
        self.parallel_adapter = ParallelAdapter(domain_adapter_dict, feature_size, dropout_rate)
    ...
    def forward(self,
        ...
        if target_domain is not None:
            x = self.sublayer(x, lambda x: self.parallel_adapter(x, self.feed_forward_layer, target_domain))
        else:
            x = self.sublayer(x, self.feed_forward_layer)
