...
class TransformerDecoderLayerWithSynthesizerAdapter(nn.Module):
    ...
    def __init__(self,
                 ...
                 domain_adapter_dict,
                 dropout_rate):
        super(TransformerDecoderLayerWithSynthesizerAdapter, self).__init__()
...
class TransformerDecoderWithSynthesizerAdapter(nn.Module):
    ...
    def __init__(self,
        ...
        super(TransformerDecoderWithSynthesizerAdapter, self).__init__()
