...
class MixtureOfAdapter(nn.Module):
    ...
    def __init__(self,
        ...
        for domain in domain_inner_gate_list:
            inner_gate[domain] = nn.Linear(in_features=feature_size, out_features=max_domain_num)
    ...
    def forward(self,
        ...
        # else we should mix the current adapters output
            ...
            if mix_weight is None:
                ...
                select_mix_weight = mix_weight.index_select(dim=-1, index=used_domain_idx)  # [B, S, D_Max] -> [B, S, D_Used]
                # print(mix_weight)
