...
from module.adapter.single_head_feedforward_adapter_layer import SingleHeadFeedForwardAdapterLayer
...
class StackedAdapter(nn.Module):
    def __init__(self, domain_adapter_dict, feature_size, dropout_rate):
        ...
        for domain in domain_adapter_dict.keys():
            _adapter_layers[domain] = SingleHeadFeedForwardAdapterLayer(input_dim=feature_size,
                                                                        memory_count=domain_adapter_dict[domain][
                                                                            'memory_count'],
