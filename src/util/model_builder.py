...
from util.model_build.make_model.make_model_with_mix_adapter_update import make_transformer_with_mix_adapter_update
...
class ModelBuilder:
    ...
    def build_model(self, model_name, model_config, vocab, device, load_pretrained=False, pretrain_path=None):
        ...
        elif model_name == 'transformer_with_mix_adapter_update':
            model = make_transformer_with_mix_adapter_update(model_config=model_config, vocab=vocab)
