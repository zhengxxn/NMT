...
def beam_search(model,
                src,
                sos_index, eos_index, pad_index, used_domain_list,
    ...
    if use_multiple_gpu:
        initial_state = model.module.prepare_for_decode(batch.src, batch.src_mask, used_domain_list)
    else:
        initial_state = model.prepare_for_decode(batch.src, batch.src_mask, used_domain_list)
