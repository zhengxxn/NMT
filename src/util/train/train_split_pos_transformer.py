import yaml
import torch
from util.trainer.transformer_with_split_position_trainer import Split_Position_Trainer
...
def main():
    ...
    model = model_builder.build_model(model_name='transformer_with_split_position',
