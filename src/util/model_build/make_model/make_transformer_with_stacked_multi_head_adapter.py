...
from module.encoder.transformer_encoder_with_stacked_multi_head_adapter import \
    TransformerEncoderLayerWithStackedMultiHeadAdapter, \
    TransformerEncoderWithStackedMultiHeadAdapter
from module.decoder.transformer_decoder_with_stacked_multi_head_adapter import \
    TransformerDecoderLayerWithStackedMultiHeadAdapter, \
    TransformerDecoderWithStackedMultiHeadAdapter
...
def make_transformer_with_stacked_multi_head_adapter(model_config, vocab):
    ...
    model = TransformerWithAdapter(
        ...
        encoder=TransformerEncoderWithStackedMultiHeadAdapter(
            layer=TransformerEncoderLayerWithStackedMultiHeadAdapter(feature_size=model_config['feature_size'],
        ...
        decoder=TransformerDecoderWithStackedMultiHeadAdapter(
            layer=TransformerDecoderLayerWithStackedMultiHeadAdapter(feature_size=model_config['feature_size'],
