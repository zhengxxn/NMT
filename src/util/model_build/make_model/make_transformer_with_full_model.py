...
import copy
from module.embedding.embedding_with_adapter import EmbeddingWithAdapter
...
from module.generator.simple_generator_with_adapter import SimpleGeneratorWithAdapter
...
from model.transformer_with_full_adapter import TransformerWithFullAdapter
...
def make_transformer_with_full_adapter(model_config, vocab):
    ...
    model = TransformerWithFullAdapter(
        ...
        generator=SimpleGeneratorWithAdapter(feature_size=model_config['feature_size'],
